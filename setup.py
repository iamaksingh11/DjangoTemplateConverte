...
setup(
  ...
  # download_url = 'https://github.com/iamaksingh11/DjangoTemplateConverter/archive/refs/tags/v_02.tar.gz',    # I explain this later on
  ...
  entry_points={
   'console_scripts': [
        'DjangoTemplateConverter = DjangoTemplateConverter.start:printLine',
    ],
  }
)